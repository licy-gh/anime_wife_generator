...
if 1:
    ...
    # Dataset.
    desc += '-stylegan_anime_faces';     dataset = EasyDict(tfrecord_dir='~/AnimeWifeGenerator/dataset_tf', resolution=512);                 train.mirror_augment = True
    ...
    sched.G_lrate_dict = {128: 0.0015, 256: 0.002, 512: 0.0003, 1024: 0.0003}
